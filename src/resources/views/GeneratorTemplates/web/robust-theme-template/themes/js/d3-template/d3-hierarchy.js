...
treeJSON = d3.json("/ajaxlegs", function (error, treeData) {
    // treeJSON = d3.json("https://raw.githubusercontent.com/d3/d3-hierarchy/v1.1.8/test/data/flare.json", function(error, treeData) {
