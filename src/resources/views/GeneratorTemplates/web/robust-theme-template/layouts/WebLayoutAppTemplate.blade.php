...
<head>
    ...
    <link rel=\"stylesheet\" type=\"text/css\" href=\"{{ asset('app-assets/vendors/css/forms/selects/selectivity-full.min.css') }}\">
    ...
    <link rel=\"stylesheet\" type=\"text/css\" href=\"{{ asset('app-assets/css/plugins/forms/selectivity/selectivity.css') }}\">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
...
<body class=\"vertical-layout vertical-content-menu 2-columns menu-expanded fixed-navbar\" data-open=\"click\" data-menu=\"vertical-content-menu\" data-col=\"2-columns\">
    ...
    <script src=\"{{ asset('app-assets/vendors/js/tables/jsgrid/jsgrid.min.js') }}\"></script>
    <script src=\"{{ asset('app-assets/vendors/js/tables/jsgrid/griddata.js') }}\"></script>
    <script src=\"{{ asset('app-assets/vendors/js/forms/select/selectivity-full.min.js') }}\"></script>
    ...
    <script src=\"{{ asset('app-assets/js/scripts/extensions/tree-view.js') }}\"></script>
    <script src=\"{{ asset('app-assets/js/scripts/tables/jsgrid/jsgrid.js') }}\"></script>
    <script src=\"{{ asset('app-assets/js/scripts/forms/select/form-selectivity.js') }}\"></script>
    <script src=\"{{ asset('app-assets/js/scripts/tables/datatables/datatable-advanced.js') }}\"></script>
    <script src=\"{{ asset('app-assets/js/scripts/extensions/block-ui.js') }}\"></script>
