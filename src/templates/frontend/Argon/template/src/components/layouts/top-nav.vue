  ...
  >
    <div class="container-fluid">
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        >
          <div class="form-group mb-0" :class="searchFocusClass">
...
export default class TopNav extends Vue {
  name: string = "top-nave";
  searchFocusClass: string = "";

  focusSearch(isFocus: boolean) {
    this.searchFocusClass = isFocus ? "focused" : "";
    console.log(this.searchFocusClass);
  }
}
</script>
